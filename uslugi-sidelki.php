	...
	<div class="container container-uslugi-sidelki">
		<div class="main-first-flex">
			...
			<ul class="grid cs-style-1">
				...
				<li>
					<figure>
						<img src="images/service_12.jpg" alt="img01">
						<figcaption>
							<h3>Сиделка суточная</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/service_11.jpg" alt="img02">
						<figcaption>
				...
				<li>
					<figure>
						<img src="images/home-care1.jpg" alt="img04">
						<figcaption>
				...
				<li>
					<figure>
						<img src="images/uslugi_1.jpeg" alt="img05">
						<figcaption>
							<h3>Сиделка почасовая</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/sidelka-na-noch.jpg" alt="img03">
						<figcaption>
							<h3>Ночная сиделка</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/uslugi_2.png" alt="img06">
						<figcaption>
							<h3>Сиделка с медицинским образованием</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/sidelka-dlya-bolnogo-demenciey-title.jpg" alt="img06">
						<figcaption>
							<h3>Сиделка-компаньонка</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/uslugi_3.jpg" alt="img06">
						<figcaption>
							<h3>Сиделка на дом</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/uslugi_4.jpg" alt="img06">
						<figcaption>
				...
				<li>
					<figure>
						<img src="images/sidelka-v-bolnizu-title.jpg" alt="img06">
						<figcaption>
							<h3>Сиделка для лежачего больного</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/sidelka-s-prozhivaniem.jpg" alt="img06">
						<figcaption>
							<h3>Сиделка для пожилого человека</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/sidelka-dlya-invalida.jpg" alt="img06">
						<figcaption>
							<h3>Сиделка для инвалида</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/uslugi_5.jpg" alt="img06">
						<figcaption>
							<h3>Сиделка для престарелых</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/uslugi_6.jpg" alt="img06">
						<figcaption>
							<h3>Сиделка для больного деменцией</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
				...
				<li>
					<figure>
						<img src="images/service_01.jpg" alt="img06">
						<figcaption>
							<h3>Сиделка для больного после инсульта</h3>
							<span>Услуги сиделки - уход за больными в Москве</span>
    ...
    <p class="catalog__text-description">Выберите подходящую услугу:</p> -->
			...
			<!-- <article class="catalog__item-wrapper">
				...
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-sutochnaya.php">
					  <img src="images/sidelka-sutochnaya.jpg" class="catalog__img-item" alt="Сиделка суточная">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-sutochnaya.php">
						<h3 class="catalog__item-title">Сиделка суточная</h3>
					</a>
				</header>
			</article> -->

			<!-- Карточка товара N2 -->
			<!-- <article class="catalog__item-wrapper catalog__item--mod">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-s-prozhivaniem.php">
					  <img src="images/sidelka-s-prozhivaniem.jpg" class="catalog__img-item" alt="Сиделка с проживанием">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-s-prozhivaniem.php">
						<h3 class="catalog__item-title">Сиделка с проживанием</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-prihodyaschaya.php">
					  <img src="images/sidelka-prihodyaschaya.jpg" class="catalog__img-item" alt="Сиделка приходящая">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-prihodyaschaya.php">
						<h3 class="catalog__item-title">Сиделка приходящая</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-pochasovaya.php">
					  <img src="images/sidelka-pochasovaya.jpg" class="catalog__img-item" alt="Сиделка почасовая">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-pochasovaya.php">
						<h3 class="catalog__item-title">Сиделка почасовая</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-nochnaya.php">
					  <img src="images/sidelka-na-noch.jpg" class="catalog__img-item" alt="Ночная сиделка">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-nochnaya.php">
						<h3 class="catalog__item-title">Ночная сиделка</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-s-med-obrazovaniem.php">
					  <img src="images/sidelka-s-med-obrazovaniem.jpg" class="catalog__img-item" alt="Сиделка с медицинским образованием">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-s-med-obrazovaniem.php">
						<h3 class="catalog__item-title">Сиделка с медицинским образованием</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-companionka.php">
					  <img src="images/sidelka-companionka.png" class="catalog__img-item" alt="Сиделка-компаньонка">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-companionka.php">
						<h3 class="catalog__item-title">Сиделка-компаньонка</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-na-dom.php">
					  <img src="images/sidelka-na-dom.jpg" class="catalog__img-item" alt="Сиделка на дом">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-na-dom.php">
						<h3 class="catalog__item-title">Сиделка на дом</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-v-bolnizu.php">
					  <img src="images/sidelka-v-bolnizu.jpg" class="catalog__img-item" alt="Сиделка в больницу">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-v-bolnizu.php">
						<h3 class="catalog__item-title">Сиделка в больницу</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-dlya-lezhachego.php">
					  <img src="images/sidelka-dlya-lezhachego.jpg" class="catalog__img-item" alt="Для лежачего больного">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-dlya-lezhachego.php">
						<h3 class="catalog__item-title">Для лежачего больного</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-dlya-pozhilyh.php">
					  <img src="images/sidelka-dlya-pozhilyh.jpg" class="catalog__img-item" alt="Для пожилых">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-dlya-pozhilyh.php">
						<h3 class="catalog__item-title">Для пожилых</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-dlya-invalida.php">
					  <img src="images/sidelka-dlya-invalida.jpg" class="catalog__img-item" alt="Для инвалида">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-dlya-invalida.php">
						<h3 class="catalog__item-title">Для инвалида</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-dlya-prestarelyh.php">
					  <img src="images/sidelka-dlya-prestarelyh.jpg" class="catalog__img-item" alt="Для престарелых">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-dlya-prestarelyh.php">
						<h3 class="catalog__item-title">Для престарелых</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-dlya-bolnogo-demenciey.php">
					  <img src="images/sidelka-dlya-bolnogo-demenciey.jpg" class="catalog__img-item" alt="Для больного деменцией">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-dlya-bolnogo-demenciey.php">
						<h3 class="catalog__item-title">Для больного деменцией</h3>
					</a>
				</header>
			</article> -->
			...
			<!-- <article class="catalog__item-wrapper">
				<section class="catalog__photo">
					<a class="catalog__photo-ref" href="sidelka-dlya-bolnogo-posle-insulta.php">
					  <img src="images/sidelka-dlya-bolnogo-posle-insulta.jpg" class="catalog__img-item" alt="Для больного после инсульта">
					</a>
				</section>
				<header>
					<a class="catalog__item-title-ref" href="sidelka-dlya-bolnogo-posle-insulta.php">
						<h3 class="catalog__item-title">Для больного после инсульта</h3>
					</a>
				</header>
			</article> -->
