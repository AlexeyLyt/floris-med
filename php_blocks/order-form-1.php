...
<div class="contact-index">
	...
	<!-- <form id="form" action="mail.php" method="POST">
		<input name="fio" type="text" class="text" placeholder="ФИО" required>
		<input name="tel" type="phone" class="text" placeholder="Ваш телефон" required>
		<select name="usluga" id="exampleFormControlSelect1" required>
			<option value="">Услуга</option>
			<option value="Сиделка суточная">Сиделка суточная</option>
			<option value="Сиделка с проживанием">Сиделка с проживанием</option>
			<option value="Сиделка приходящая">Сиделка приходящая</option>
			<option value="Сиделка в больницу">Сиделка в больницу</option>
			<option value="Уход за больными (Альцгеймера, деменции, перенесших инсульт)">Уход за больными (Альцгеймера, деменции, перенесших инсульт)</option>
		</select>
		<textarea name="mes" onfocus="if(this.value == 'MESSAGE') this.value='';" placeholder="Комментарий"></textarea>
